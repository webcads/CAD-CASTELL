...
export interface Supervisor<T> extends Supervisor.Variance<T> {
     ...
     */
    readonly onStart: <R, E, A>(context: Context.Context<R>, effect: Effect.Effect<R, E, A>, parent: Option.Option<Fiber.RuntimeFiber<any, any>>, fiber: Fiber.RuntimeFiber<E, A>) => void;
    /**
