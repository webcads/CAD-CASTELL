...
export interface Strategy<A> extends Queue.StrategyVariance<A> {
     ...
     * operation.
     */
    readonly handleSurplus: (iterable: Iterable<A>, queue: BackingQueue<A>, takers: MutableQueue.MutableQueue<Deferred.Deferred<never, A>>, isShutdown: MutableRef.MutableRef<boolean>) => Effect.Effect<never, never, boolean>;
    /**
     ...
     */
    readonly unsafeOnQueueEmptySpace: (queue: BackingQueue<A>, takers: MutableQueue.MutableQueue<Deferred.Deferred<never, A>>) => void;
}
/**
 * @since 2.0.0
 * @category models
