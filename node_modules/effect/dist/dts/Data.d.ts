...
export interface YieldableError extends Case, Pipeable, Readonly<Error> {
    ...
    readonly [Effectable.ChannelTypeId]: Channel.Channel.VarianceStruct<never, unknown, unknown, unknown, this, never, never>;
}
/**
 * Provides a constructor for a Case Class.
 *
 ...
 * @category constructors
 */
export declare const TaggedError: <Tag extends string>(tag: Tag) => new <A extends Record<string, any>>(args: Types.Equals<Omit<A, keyof Equal.Equal>, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" | keyof Equal.Equal ? never : P]: A[P]; }) => YieldableError & {
    readonly _tag: Tag;
} & Readonly<A>;
