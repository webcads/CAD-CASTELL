 ...
 * @category constructors
 */
export declare const fromFunctionBatched: <A extends Request.Request<never, any>>(f: (chunk: Array<A>) => Iterable<Request.Request.Success<A>>) => RequestResolver<A, never>;
/**
 ...
 * @category constructors
 */
export declare const fromEffect: <R, A extends Request.Request<any, any>>(f: (a: A) => Effect.Effect<R, Request.Request.Error<A>, Request.Request.Success<A>>) => RequestResolver<A, R>;
/**
...
export declare const fromEffectTagged: <A extends Request.Request<any, any> & {
    ...
    readonly [Tag in A["_tag"]]: [Extract<A, {
        readonly _tag: Tag;
    }>] extends [infer Req] ? Req extends Request.Request<infer ReqE, infer ReqA> ? (requests: Array<Req>) => Effect.Effect<any, ReqE, Iterable<ReqA>> : never : never;
}>(fns: Fns) => RequestResolver<A, ReturnType<Fns[keyof Fns]> extends Effect.Effect<infer R, infer _E, infer _A> ? R : never>;
/**
