...
export declare namespace Types {
    ...
    type ResolvePred<A> = A extends never ? never : A extends Predicate.Refinement<any, infer P> ? P : A extends Predicate.Predicate<infer P> ? P : A extends SafeRefinement<any> ? A : A extends Record<string, any> ? DrainOuterGeneric<{
        [K in keyof A]: ResolvePred<A[K]>;
    }> : A;
    type ToSafeRefinement<A> = A extends never ? never : A extends Predicate.Refinement<any, infer P> ? SafeRefinement<P, P> : A extends Predicate.Predicate<infer P> ? SafeRefinement<P, never> : A extends SafeRefinement<any> ? A : A extends Record<string, any> ? DrainOuterGeneric<{
     ...
     * @since 1.0.0
     */
    type PatternBase<A> = A extends ReadonlyArray<infer _T> ? ReadonlyArray<any> | PatternPrimitive<A> : A extends Record<string, any> ? Partial<DrainOuterGeneric<{
