...
export interface MetricRegistry {
    ...
    readonly get: <Type extends MetricKeyType.MetricKeyType<any, any>>(key: MetricKey.MetricKey<Type>) => MetricHook.MetricHook<MetricKeyType.MetricKeyType.InType<typeof key["keyType"]>, MetricKeyType.MetricKeyType.OutType<typeof key["keyType"]>>;
    readonly getCounter: <A extends (number | bigint)>(key: MetricKey.MetricKey.Counter<A>) => MetricHook.MetricHook.Counter<A>;
