 ...
 * @since 2.0.0
 */
const fromIterable = exports.fromIterable = /*#__PURE__*/(0, _Function.dual)(2, (self, f) => {
  const out = {};
  for (const a of self) {
    const [k, b] = f(a);
    out[k] = b;
 ...
 * @since 2.0.0
 */
const fromEntries = exports.fromEntries = /*#__PURE__*/fromIterable(_Function.identity);
/**
 ...
 * @since 2.0.0
 */
const compact = exports.compact = /*#__PURE__*/filterMap(_Function.identity);
/**
 ...
 * @since 2.0.0
 */
const every = exports.every = /*#__PURE__*/(0, _Function.dual)(2, (self, predicate) => {
  for (const key in self) {
    if (!predicate(self[key], key)) {
      return false;
    }
