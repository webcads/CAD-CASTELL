 ...
 * @since 2.0.0
 */
const append = exports.append = /*#__PURE__*/(0, _Function.dual)(2, (self, a) => appendAllNonEmpty(self, of(a)));
/**
 ...
 * @since 2.0.0
 */
const prepend = exports.prepend = /*#__PURE__*/(0, _Function.dual)(2, (self, elem) => appendAllNonEmpty(of(elem), self));
/**
 ...
 * @since 2.0.0
 */
const dropWhile = exports.dropWhile = /*#__PURE__*/(0, _Function.dual)(2, (self, f) => {
 ...
 * @since 2.0.0
 */
const prependAllNonEmpty = exports.prependAllNonEmpty = /*#__PURE__*/(0, _Function.dual)(2, (self, that) => prependAll(self, that));
/**
 ...
 * @since 2.0.0
 */
const appendAllNonEmpty = exports.appendAllNonEmpty = /*#__PURE__*/(0, _Function.dual)(2, (self, that) => appendAll(self, that));
/**
 ...
 * @since 2.0.0
 */
const flatMapNonEmpty = exports.flatMapNonEmpty = flatMap;
/**
 ...
 * @since 2.0.0
 */
const flattenNonEmpty = exports.flattenNonEmpty = /*#__PURE__*/flatMapNonEmpty(_Function.identity);
/**
