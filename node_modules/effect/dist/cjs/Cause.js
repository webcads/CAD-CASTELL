 ...
 * @category symbols
 */
const RuntimeExceptionTypeId = exports.RuntimeExceptionTypeId = internal.RuntimeExceptionTypeId;
/**
 * @since 2.0.0
 * @category symbols
 */
const InterruptedExceptionTypeId = exports.InterruptedExceptionTypeId = internal.InterruptedExceptionTypeId;
/**
 * @since 2.0.0
 * @category symbols
 */
const IllegalArgumentExceptionTypeId = exports.IllegalArgumentExceptionTypeId = internal.IllegalArgumentExceptionTypeId;
/**
 * @since 2.0.0
 * @category symbols
 */
const NoSuchElementExceptionTypeId = exports.NoSuchElementExceptionTypeId = internal.NoSuchElementExceptionTypeId;
/**
 * @since 2.0.0
 * @category symbols
 */
const InvalidPubSubCapacityExceptionTypeId = exports.InvalidPubSubCapacityExceptionTypeId = internal.InvalidPubSubCapacityExceptionTypeId;
/**
 ...
 */
const squash = exports.squash = internal.squash;
/**
 * Squashes a `Cause` down to a single defect, chosen to be the "most important"
 ...
 * @category destructors
 */
const squashWith = exports.squashWith = internal.squashWith;
/**
 ...
 * @category errors
 */
const InterruptedException = exports.InterruptedException = internal.InterruptedException;
/**
 ...
 * @category refinements
 */
const isInterruptedException = exports.isInterruptedException = internal.isInterruptedException;
/**
 ...
 * @category errors
 */
const IllegalArgumentException = exports.IllegalArgumentException = internal.IllegalArgumentException;
/**
 ...
 * @category refinements
 */
const isIllegalArgumentException = exports.isIllegalArgumentException = internal.isIllegalArgumentException;
/**
 ...
 * @category errors
 */
const NoSuchElementException = exports.NoSuchElementException = internal.NoSuchElementException;
/**
 ...
 * @category refinements
 */
const isNoSuchElementException = exports.isNoSuchElementException = internal.isNoSuchElementException;
/**
 ...
 * @category errors
 */
const RuntimeException = exports.RuntimeException = internal.RuntimeException;
/**
 ...
 * @category refinements
 */
const isRuntimeException = exports.isRuntimeException = internal.isRuntimeException;
/**
 ...
 * @category errors
 */
const originalError = exports.originalError = _core.originalInstance;
