...
/** @internal */
const ConfigSecretTypeId = exports.ConfigSecretTypeId = /*#__PURE__*/Symbol.for(ConfigSecretSymbolKey);
/** @internal */
const proto = exports.proto = {
  [ConfigSecretTypeId]: ConfigSecretTypeId,
  [Hash.symbol]() {
    return (0, _Function.pipe)(Hash.hash(ConfigSecretSymbolKey), Hash.combine(Hash.array(this.raw)));
  },
  [Equal.symbol](that) {
...
/** @internal */
const isConfigSecret = u => (0, _Predicate.hasProperty)(u, ConfigSecretTypeId);
/** @internal */
