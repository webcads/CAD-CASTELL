...
/** @internal */
const runtimeFiberVariance = exports.runtimeFiberVariance = {
  _E: _ => _,
  _A: _ => _
};
const absurd = _ => {
...
const forEachParUnboundedDiscard = (self, f, batching) => core.suspend(() => {
  ...
  return core.uninterruptibleMask(restore => {
    ...
    const residual = [];
    const joinOrder = [];
    const process = core.transplant(graft => core.forEachSequential(as, (a, i) => (0, _Function.pipe)(graft((0, _Function.pipe)(core.suspend(() => restore((batching ? core.step : core.exit)(f(a, i)))), core.flatMap(exit => {
      switch (exit._op) {
        case "Failure":
          {
