...
class Complete {
  ...
  [Hash.symbol]() {
    return pipe(Hash.string("effect/KeyedPool/Complete"), Hash.combine(Hash.hash(this.pool)));
  }
  [Equal.symbol](u) {
...
class Pending {
  ...
  [Hash.symbol]() {
    return pipe(Hash.string("effect/KeyedPool/Pending"), Hash.combine(Hash.hash(this.deferred)));
  }
  [Equal.symbol](u) {
