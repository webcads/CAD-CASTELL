 ...
 * @since 2.0.0
 */
export const toArray = self => Array.from(self);
/**
 * @category equivalence
 * @since 2.0.0
 */
export const getEquivalence = isEquivalent => Equivalence.mapInput(ReadonlyArray.getEquivalence(isEquivalent), toArray);
